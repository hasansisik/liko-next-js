...
// service images
import service_1 from "@/assets/img/inner-service/service/service-1.jpg";
import service_2 from "@/assets/img/inner-service/service/service-2.jpg";
import service_3 from "@/assets/img/inner-service/service/service-3.jpg";
import service_4 from "@/assets/img/inner-service/service/service-4.jpg";
...
export const service_data: IServiceDT[] = [
  {
    id: 1,
    img: service_1,
...
// Export specific service categories
export const cosmetic_services = service_data.filter(service => service.category === 'Cosmetic Dentistry');
export const restorative_services = service_data.filter(service => service.category === 'Restorative Dentistry');
export const all_services = service_data; 